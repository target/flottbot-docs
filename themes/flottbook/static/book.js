...
(function codeSnippets() {
  ...
  function run_rust_code(code_block) {
    ...
    request
      ...
      .then(function(response) {
        result_block.innerText = response.success
          ? response.stdout
          : response.stderr;
      })
  ...
  Array.from(document.querySelectorAll("code.language-rust")).forEach(function(
    ...
    for (var n = 0; n < lines.length; n++) {
      ...
      if (
        trimmed_line[0] == hiding_character &&
        trimmed_line[1] != hiding_character
      ) {
  ...
  Array.from(document.querySelectorAll(".playpen")).forEach(function(
    pre_block
  ) {
    // Add play button
    var buttons = pre_block.querySelector(".buttons");
